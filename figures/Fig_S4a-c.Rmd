...
p.clustree <- clustree(seu, node_text_size = 0, edge_width = 1)+labs(title = paste0("npcs = ",NPCs))
p.clustree
ggsave(p.clustree, filename = paste0("figures/Fig_S4a_phase_",NPCs,".pdf"),
...
df <- data.frame(row.names = rownames(seu@meta.data),
                 TF = seu$TF,
                 Cluster = seu$integrated_snn_res.0.6)
